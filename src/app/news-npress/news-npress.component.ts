...
@Component({
  selector: 'app-news-npress',
  templateUrl: './news-npress.component.html',
  styleUrls: ['./news-npress.component.css']
})
export class NewsNpressComponent {
